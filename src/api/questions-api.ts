 ...
 */
 export const addQuestionAsync = async (questionDetail: IQuestion) => {
    ...
    const {questionDescription, questionId, questionTitle, userId, subjectId} = questionDetail;
    var res = await fetch("https://solvesample-default-rtdb.firebaseio.com/sampleQuestions.json",
        {
            method: "POST",
            headers: {
